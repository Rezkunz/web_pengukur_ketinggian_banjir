    ...
    if (user) {
        ...
        if (role === 'admin') {
            if (!viewAdminDash.innerHTML) {
                ...
                viewAdminSaran.innerHTML = await fetch('views/admin-saran.html?v=98').then(r => r.text());
                viewAdminMembers.innerHTML = await fetch('views/admin-members.html?v=98').then(r => r.text());
            }
            ...
            if (!viewMonitoring.innerHTML) {
                viewMonitoring.innerHTML = await fetch('views/monitoring.html?v=98').then(r => r.text());
                viewDarurat.innerHTML = await fetch('views/darurat.html?v=98').then(r => r.text());
                viewLapor.innerHTML = await fetch('views/lapor.html?v=98').then(r => r.text());
                viewSaran.innerHTML = await fetch('views/saran.html?v=98').then(r => r.text());
            }
