        ...
        if (user) {
            ...
            if (userData.role === 'admin') {
                if (!viewAdminDash.innerHTML) {
                    viewAdminDash.innerHTML = await fetch('views/admin-dashboard.html?v=3').then(r => r.text());
                    viewAdminLapor.innerHTML = await fetch('views/admin-laporan.html?v=3').then(r => r.text());
                    viewAdminSaran.innerHTML = await fetch('views/admin-saran.html?v=3').then(r => r.text());
                }
                ...
                if (!viewMonitoring.innerHTML) {
                    viewMonitoring.innerHTML = await fetch('views/monitoring.html?v=3').then(r => r.text());
                    viewDarurat.innerHTML = await fetch('views/darurat.html?v=4').then(r => r.text());
                    viewLapor.innerHTML = await fetch('views/lapor.html?v=3').then(r => r.text());
                    viewSaran.innerHTML = await fetch('views/saran.html?v=3').then(r => r.text());
                }
            ...
            if (!viewAuth.innerHTML) {
                viewAuth.innerHTML = await fetch('views/auth.html?v=3').then(r => r.text());
            }
